            ...
            <div className="relative z-20 mt-8 flex items-center justify-center gap-x-4 md:mt-10">
              <div className="relative group">
                ...
                <Link href="/nfts">
                  <Button
                    variant="outline"
                    className="relative z-10 text-xl md:text-2xl lg:text-3xl px-10 py-8 md:px-14 md:py-10 font-bold text-blue-400 border-blue-400 border-2 hover:text-blue-300 hover:border-blue-300 transition-all duration-300 transform hover:scale-105 shadow-[0_0_15px_rgba(59,130,246,0.5)] hover:shadow-[0_0_25px_rgba(59,130,246,0.7)] bg-neutral-900/80 rounded"
                    title="BUY A SLUGGER"
                  >
                    BUY A SLUGGER
                  </Button>
